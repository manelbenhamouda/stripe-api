...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['App\\Kernel', 'App\\Controller\\PaymentController', 'App\\Controller\\ProductController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    private $loadedDynamicParameters = [
        ...
        'stripe.public_key' => false,
        'stripe.secret_key' => false,
        'stripe.webhook_secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'stripe.public_key' => $container->getEnv('STRIPE_PUBLIC_KEY'),
            'stripe.secret_key' => $container->getEnv('STRIPE_SECRET_KEY'),
            'stripe.webhook_secret' => $container->getEnv('STRIPE_WEBHOOK_SECRET'),
